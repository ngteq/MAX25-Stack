<!-- AUTO-SYNC 2026-07-13 — vault: projects/integration/2026-07-13-master-operator-guide.md -->
<!-- Re-sync: /home/akb/Code/0-RESEARCHES/tools/vault-sync-slave-docs.sh -->

# AX25SRV — Dual-TNC operator guide
...
Linear operator sequence for a **standalone Main** host with **one or two local TNCs** (AX25SRV pattern): MAX25 prep first, HyBBX second, RF verification last. Applies to any dual-TNC reference station — adjust device paths and INI per site.
...
Note: one `max25d` instance = one RF backend in v1; dual-TNC sites often use **scripts per port** then HyBBX as serial owner. See vault prep check for AX25SRV pattern.
...
RF debug timeline: [../hybbx/2026-07-12-ax25srv-rf-broadcast-investigation.md](../hybbx/2026-07-12-ax25srv-rf-broadcast-investigation.md).
...
| RF investigation | [../hybbx/2026-07-12-ax25srv-rf-broadcast-investigation.md](../hybbx/2026-07-12-ax25srv-rf-broadcast-investigation.md) |
