...
// This is ALSASound.c for Linux / *BSD (ALSA) and macOS (CoreAudio shim)
...
int GetOutputDeviceCollection(void)
{
	return darwin_get_output_device_collection();
}

int GetNextOutputDevice(char * dest, int max, int n)
{
	return darwin_get_next_output_device(dest, max, n);
}

int GetInputDeviceCollection(void)
{
	return darwin_get_input_device_collection();
}

int GetNextInputDevice(char * dest, int max, int n)
{
	return darwin_get_next_input_device(dest, max, n);
}
